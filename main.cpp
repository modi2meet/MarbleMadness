...
const string assetDirectory = "/Users/meetmodi/Desktop/DerivedData/MarbleMadness/Build/Products/Debug/Assets";
const int msPerTick = 20;  // 10ms per tick; increase this if game moves too fast
